...
export const SEED_DOCTORS: Doctor[] = [
  {
    ...
    fullName: "TS.BS Nguyễn Minh Khôi",
    slug: "nguyen-minh-khoi",
    title: "Bác sĩ chuyên khoa Tim mạch",
    specialtyName: "Tim mạch",
    bio: "Chuyên khoa tim mạch can thiệp, 18 năm kinh nghiệm điều trị bệnh mạch vành.",
    experienceYears: 18,
  ...
  },
  {
    ...
    fullName: "ThS.BS Trần Thu Hà",
    slug: "tran-thu-ha",
    title: "Bác sĩ chuyên khoa Thần kinh",
    specialtyName: "Thần kinh",
    bio: "Chuyên khoa thần kinh, 12 năm kinh nghiệm khám và điều trị đau đầu mãn tính.",
    experienceYears: 12,
    branchId: "20000000-0000-0000-0000-000000000001",
  ...
  },
  {
    ...
    fullName: "BS.CKI Lê Văn Đức",
    slug: "le-van-duc",
    title: "Bác sĩ chuyên khoa Tiêu hóa",
    specialtyName: "Tiêu hóa",
    bio: "Chuyên khoa tiêu hóa – gan mật, 15 năm kinh nghiệm nội soi tiêu hóa.",
    experienceYears: 15,
  ...
  },
  {
    ...
    fullName: "ThS.BS Phạm Hoàng Yến",
    slug: "pham-hoang-yen",
    title: "Bác sĩ chuyên khoa Nhi",
    specialtyName: "Nhi khoa",
    bio: "Chuyên khoa nhi, 10 năm kinh nghiệm khám và điều trị trẻ em.",
    experienceYears: 10,
    branchId: "20000000-0000-0000-0000-000000000002",
