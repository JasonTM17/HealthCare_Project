...
export default function HuongDanPage() {
  ...
  const insurancePartners = [
    { name: "Bảo Việt Nhân Thọ & Phi Nhân Thọ", type: "Bảo lãnh trực tiếp", discount: "100% hạn mức thẻ" },
    { name: "Prudential Vietnam", type: "Bảo lãnh điện tử", discount: "Theo quyền lợi thẻ PRU" },
    { name: "PVI Insurance", type: "Bảo lãnh nội/ngoại trú", discount: "Thẻ PVI Care" },
    { name: "Manulife Vietnam", type: "Thẻ Manulife Move", discount: "Bảo lãnh viện phí 24/7" },
    { name: "AIA Vietnam", type: "AIA Vitality", discount: "Quyền lợi VIP Care" },
    { name: "Dai-ichi Life Vietnam", type: "Thẻ Chăm sóc sức khỏe toàn cầu", discount: "Bảo lãnh viện phí trực tiếp" },
    { name: "Generali Vietnam", type: "VITA - Sống Như Ý", discount: "Bảo lãnh nhanh 15 phút" },
    { name: "Bảo Minh Insurance", type: "Bảo hiểm sức khỏe", discount: "Nội/Ngoại trú" },
    { name: "Insmart / Pacific Cross", type: "TPA Quốc tế", discount: "Bảo lãnh viện phí đa quốc gia" },
  ];
    ...
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 font-sans">
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="text-xs text-slate-500 flex items-center gap-2">
          ...
          <span>/</span>
          <span className="text-teal-900 font-semibold">Hướng dẫn khám bệnh & Bảo hiểm y tế</span>
        </div>
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-teal-950 mt-2 font-serif">
        ...
        <section className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="p-5 bg-teal-50/50 border border-teal-100 rounded-2xl space-y-2">
              <span className="w-9 h-9 rounded-xl bg-teal-700 text-white font-extrabold text-base flex items-center justify-center">
                1
              </span>
              <h3 className="font-bold text-slate-900 text-sm">Đặt Lịch Hẹn</h3>
            ...
            <div className="p-5 bg-teal-50/50 border border-teal-100 rounded-2xl space-y-2">
              ...
              <h3 className="font-bold text-slate-900 text-sm">Tiếp Đón & Đo Sinh Hiệu</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <div className="p-5 bg-teal-50/50 border border-teal-100 rounded-2xl space-y-2">
              ...
              <h3 className="font-bold text-slate-900 text-sm">Khám Chuyên Khoa</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <div className="p-5 bg-teal-50/50 border border-teal-100 rounded-2xl space-y-2">
              ...
              <h3 className="font-bold text-slate-900 text-sm">Kết Luận & Lấy Thuốc</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
        ...
        <section className="bg-teal-950 text-white p-8 sm:p-10 rounded-3xl shadow-xl space-y-8">
          <div>
            ...
            <p className="text-teal-200 text-xs sm:text-sm mt-2 max-w-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {insurancePartners.map((item, idx) => (
              <div key={idx} className="p-4 bg-white/10 border border-white/15 rounded-2xl space-y-1">
                ...
                <p className="text-xs text-teal-200">{item.type} • <span className="text-emerald-300">{item.discount}</span></p>
              </div>
            ))}
          </div>

          <div className="p-5 bg-teal-900/80 border border-teal-700/60 rounded-2xl text-xs text-teal-100 space-y-2">
        ...
        <section className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 space-y-1.5">
              <h4 className="font-bold text-slate-900">Tôi có cần nhịn ăn trước khi xét nghiệm máu hoặc khám tổng quát không?</h4>
            ...
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 space-y-1.5">
              <h4 className="font-bold text-slate-900">Bệnh viện có khám vào ngày Chủ Nhật và ngoài giờ hành chính không?</h4>
              <p className="text-slate-600 text-xs leading-relaxed">
            ...
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 space-y-1.5">
              <h4 className="font-bold text-slate-900">Nếu tôi đến trễ hơn giờ hẹn đã đặt thì lịch khám có bị hủy không?</h4>
              <p className="text-slate-600 text-xs leading-relaxed">
          ...
          <div className="pt-4 text-center">
            <button
              ...
              className="px-8 py-3 bg-teal-700 hover:bg-teal-800 text-white font-bold text-xs rounded-full shadow-md transition-all cursor-pointer"
            >
