...
// The care-plan payload identifies the source appointment only by its raw
// database UUID (`CarePlan.appointmentId`); no human reference (booking code)
// is available to the patient endpoint. Truncating a UUID to "75ddcbe7…"
// showed patients an unquotable id fragment, so the row renders a placeholder
