    ...
    <div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
        <section aria-labelledby="specialty-form-title" className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          ...
          <div className="mt-4"><AdminState tone="unavailable" title="Auth transport chưa hoàn thiện ở baseline" description="Các helper admin hiện chưa gắn Authorization từ phiên browser. Form vẫn phản ánh đúng request contract; nếu backend trả 401/403, trang sẽ giữ nguyên trạng thái lỗi." /></div>
