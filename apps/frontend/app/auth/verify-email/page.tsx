        ...
        {verified ? (
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            <div className="auth-form__field">
              ...
              {fieldErrors.code ? <small className="auth-form__field-error" id="verify-code-error">{fieldErrors.code}</small> : <small id="verify-code-help">Mã gồm các ký tự trong email xác minh.</small>}
            </div>
