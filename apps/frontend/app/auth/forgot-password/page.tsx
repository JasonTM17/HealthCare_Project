        ...
        {submitted ? (
          ...
          <form className="auth-form" noValidate onSubmit={handleSubmit}>
            ...
            <div className="auth-form__field">
              ...
              <input aria-describedby={fieldErrors.email ? "forgot-email-error" : "forgot-email-help"} aria-invalid={Boolean(fieldErrors.email)} autoComplete="email" id="forgot-email" name="email" onChange={(event) => setEmail(event.target.value)} placeholder="email@example.com" required type="email" value={email} />
