...
(
    ...
    '30000000-0000-0000-0000-000000000001',
    1,
    'Đo huyết áp bắp tay 2 lần/ngày (sáng sau thức dậy và tối trước khi ngủ), ghi vào sổ nhật ký',
    'Báo ngay cho bác sĩ qua kênh tư vấn nếu huyết áp tâm thu > 150 mmHg hoặc tâm trương > 95 mmHg',
    'DONE',
...
(
    ...
    '30000000-0000-0000-0000-000000000001',
    2,
    'Duy trì chế độ ăn giảm muối DASH (< 5g muối/ngày), kiêng rượu bia và thuốc lá',
    'Tăng cường rau xanh, cá béo và các loại hạt; không nêm thêm nước mắm khi ăn',
    'OPEN',
...
(
    ...
    '30000000-0000-0000-0000-000000000001',
    3,
    'Tập thể dục vừa sức: đi bộ nhanh hoặc đạp xe 30 phút mỗi ngày, tối thiểu 5 ngày/tuần',
    'Không tập gắng sức quá mức khi nhịp tim vượt quá 120 chu kỳ/phút',
    'OPEN',
...
(
    ...
    '30000000-0000-0000-0000-000000000001',
    4,
    'Tái khám chuyên khoa Tim mạch đúng hẹn vào ngày hẹn trên hệ thống để đánh giá chức năng thận và phác đồ thuốc',
    'Mang theo sổ theo dõi huyết áp và các đơn thuốc đang sử dụng',
    'OPEN',
    CURRENT_TIMESTAMP + INTERVAL '5 days',
    NULL,
    CURRENT_TIMESTAMP + INTERVAL '300 days'
...
(
    ...
    'PATIENT',
    1,
    'Kính chào Bác sĩ Khôi. Tôi uống thuốc theo toa được 1 tuần nay thì đo huyết áp sáng thường ở mức 125/80 mmHg, tối khoảng 130/82 mmHg. Tôi không còn cảm giác đau đầu sau gáy nữa. Như vậy là huyết áp đã ổn định chưa ạ?',
    'TEXT',
    'msg-patient-001',
...
(
    ...
    'DOCTOR',
    2,
    'Chào bạn An. Mức huyết áp 125/80 mmHg là rất lý tưởng và cho thấy bạn đáp ứng rất tốt với phác đồ Amlodipine + Losartan hiện tại. Bạn tiếp tục duy trì uống thuốc đúng giờ, tránh bỏ cữ và giữ chế độ ăn nhạt nhé. Hẹn gặp lại bạn vào buổi tái khám tuần tới để kiểm tra lại chức năng thận.',
    'TEXT',
    'msg-doctor-002',
    CURRENT_TIMESTAMP - INTERVAL '2 days',
    CURRENT_TIMESTAMP + INTERVAL '80 days'
...
(
    ...
    'PATIENT',
    3,
    'Dạ cảm ơn Bác sĩ rất nhiều. Tôi sẽ tiếp tục theo dõi và đến tái khám đúng hẹn ạ.',
    'TEXT',
    'msg-patient-003',
    CURRENT_TIMESTAMP - INTERVAL '1 day',
    CURRENT_TIMESTAMP + INTERVAL '80 days'
