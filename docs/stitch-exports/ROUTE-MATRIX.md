...
The public detail contracts are backed by Flyway V15/V16 and the local rich-content
...
sections. The base seed remains replayable against the pre-V15 migration
fixtures used by `FlywayMigrationTest`.
